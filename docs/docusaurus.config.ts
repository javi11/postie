...
const config: Config = {
  title: 'Postie',
  tagline: 'A high-performance Usenet binary poster written in Go',
  favicon: 'img/favicon.ico',

  // Set the production url of your site here
  url: 'https://postie.kipsilabs.top',
  ...
  themeConfig: {
    ...
    image: 'img/postie-social-card.jpg',
    navbar: {
      title: 'Postie',
      logo: {
        alt: 'Postie Logo',
    ...
    footer: {
      ...
      copyright: `Copyright © ${new Date().getFullYear()} Postie Project. Built with Docusaurus.`,
    },
    prism: {
